<?php /*a:5:{s:67:"/www/wwwroot/lingzweb/public/../templates/default/cms/category.html";i:1628763224;s:65:"/www/wwwroot/lingzweb/public/../templates/default/cms/header.html";i:1628763224;s:64:"/www/wwwroot/lingzweb/public/../templates/default/cms/sider.html";i:1628763224;s:72:"/www/wwwroot/lingzweb/public/../templates/default/cms/category_ajax.html";i:1628763224;s:65:"/www/wwwroot/lingzweb/public/../templates/default/cms/footer.html";i:1628763224;}*/ ?>
...
$offset=($page-1)*5;
$limit="$offset,5";
 $cache = 0;$cacheID = to_guid_string(array('module'=>'cms','action'=>'lists','catid'=>$catid,'order'=>'listorder DESC','limit'=>$limit,'return'=>'data','page'=>'0',));if($cache && $_return = Cache::get($cacheID)):$data = $_return;else: $cmsTagLib =  \think\Container::get("\\app\\cms\\taglib\\CmsTagLib");if(method_exists($cmsTagLib, "lists")):$data = $cmsTagLib->lists(array('module'=>'cms','action'=>'lists','catid'=>$catid,'order'=>'listorder DESC','limit'=>$limit,'return'=>'data','page'=>'0',));if($cache):Cache::set($cacheID, $data, $cache);endif;endif;endif; if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
<li class="item clearfix">
    <a href="<?php echo htmlentities($vo['url']); ?>" title="<?php echo htmlentities($vo['title']); ?>"><img class="fl" src="<?php echo htmlentities((isset($vo['thumb']) && ($vo['thumb'] !== '')?$vo['thumb']:'https://via.placeholder.com/168x126')); ?>" alt="<?php echo htmlentities($vo['title']); ?>">
